              ...
              <StaggerItem>
                <Card className="text-center border-2 hover:shadow-xl hover:border-blue-200 transition-all h-full">
                  <CardContent className="p-8">
                    ...
                    <p className="text-muted-foreground leading-relaxed">
                      Connecting talented students from 140+ countries with opportunities at 1,000+ universities worldwide, fostering diversity and global collaboration in academia.
                    </p>
                  </CardContent>
                </Card>
              </StaggerItem>
